<nav class="flex flex-row h-[100px] bg-[#49BF8C] gap-3">
        <div class=" w-1/12 flex flex-row items-center justify-center">
            <img src="/techshop/public/img/large.png" alt="Logo techshop" class="h-[72px] w-[72px] rounded-full">
        </div>    
        ...
        <span class="my-auto text-4xl">|</span>
        <div class="w-2/12 flex justify-center my-auto">
            <a href="/techshop/public/login/index" class="w-4/5 flex flex-row justify-center items-center gap-[1rem] bg-[#DCCF55] hover:bg-[#dcad11] p-[1rem] rounded-full border-2 border-[#111] text-sm">
            <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z"/></svg>
            <p>Đăng nhập</p>
            </a>
        </div>
        <div class="w-2/12 flex justify-center my-auto">
            <a href="/techshop/public/cart/index" class="w-4/5 flex flex-row justify-center items-center gap-[1rem] bg-[#DCCF55] hover:bg-[#dcad11] p-[1rem] rounded-full border-2 border-[#111] text-sm">
