<footer class="w-[100vw] bg-[#D9D2D2] flex md:flex-row flex-column py-[1rem]">
    ...
    <div class="w-[50%] grid grid-rows-2">
        <div class="row-span-1">
            <p class="text-lg font-bold">Giới thiệu</p>
            <a href="#"><p class="mb-[0.5rem]">&emsp;Giới thiệu về công ty (TechShop)</p></a>
            <a href="#"><p class="mb-[0.5rem]">&emsp;Chính sách bảo hành</p></a>
            <a href="#"><p class="mb-[0.5rem]">&emsp;Tuyển dụng</p></a>
            <a href="#"><p class="mb-[0.5rem]">&emsp;Góp ý khiếu nại</p></a>
            <a href="#"><p class="mb-[0.5rem]">&emsp;Tìm cửa hàng gần nhất</p></a>
        </div>

        <div class="grid grid-cols-10 grid-rows-3 gap-4 mt-[1rem] row-span-1">
            <div class="row-span-3 col-span-3"><img src="/techshop/public/img/large.png" alt="logo" class="rounded-full w-[100px] h-[100px]"></div>
            <p class="row-span-1 col-span-7 text-xl font-bold">TECHSHOP</p>
            <ul class="row-span-2 col-span-5 list-disc">
                <li class="mb-[0.5rem]">Cơ sở Lý Thường Kiệt: 268 Lý Thường Kiệt, Phường 14, Quận 10, TP. HCM</li>
                <li class="mb-[0.5rem]">Cơ sở Dĩ An: Khu phố Tân Lập, Phường Đông Hòa, TP. Dĩ An, Tỉnh Bình Dương</li>
            </ul>
        </div>
    </div>
</footer>