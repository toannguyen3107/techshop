...
forEach ($papers as $paperItem) {
    echo '<div class="relative min-h-full min-w-50 mx-4 max-w-sm bg-[#c4f2d9]  hover:bg-[#81e4b4] border border-gray-200 rounded-lg shadow mb-4" style="min-width: 20rem;">
    <a href="#" class="d-flex">';
