...
<head>
    ...
    $(document).ready(function(){
        ...
        $('#more').click(function(){
            ...
            $.ajax({
                url: '/techshop/public/api/productrecommendPhone',
                method: 'GET',
                dataType: 'json',
...
<?php require_once '../app/component/nav.php'?>
    <p class="cursor-pointer selected text-[#fff] border-2 border-[#fff] rounded-[0.5rem] text-center bg-[#6C628C] p-[0.3rem] mr-[0.5rem] font-bold text-[2rem] lg:text-base w-[20rem] m-[1rem]" id="phone">ĐIỆN THOẠI</p>
